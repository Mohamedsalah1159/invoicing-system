...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Sittings</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    Products</span>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $Product)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $Product->section->section_name ?? null }}</td>
                                        <td>{{ $Product->description }}</td>
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-name="{{ $Product->product_name }}
												data-pro_id="{{ $Product->id }}"
                                                data-section_name="{{ $Product->section->section_name??null }}"
